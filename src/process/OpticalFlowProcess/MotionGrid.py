...
HORIZONTALSUBFRAMECOUNT = 3 # Will be multiplied by 4 to store right, left, up, and down movement sub frames
VERTICALSUBFRAMECOUNT = 5
...
def main():
    ...
    # for KTH
    # actionArray = ["boxing", "handwaving","walking"]
