...
actionArray = ["bend", "jack", "jump", "pjump", "run", "side", "skip", "walk", "wave1", "wave2"]
subjectArray = ["daria", "denis", "eli", "ido", "ira", "lena", "lyova", "moshe", "shahar"]
...
for Subject in subjectArray:
    for Action in actionArray:
        ...
        inputDirectory = "/home/melassal/Workspace/Datasets/Weizmann/Weizmann_LOO/" + Subject + "/" + ContainingFolder + "/" + Action
        # Choose where to save these generated cubes.
        outputDirectory = "/home/melassal/Workspace/Datasets/Weizmann/Weizmann_EG/" + Subject + "/" + ContainingFolder + "/" + Action
