...
file_name = "Weiz-seeFSGauss-daria"
file_path = "/home/melassal/Workspace/CSNN/csnn-simulator-build/ExtractedTimestamps/"+file_name+"/train/"+file_name+"_input_spikes"

with open(file_path + ".json", "r") as s1:
    data = s1.read()
