...
int main(int argc, char** argv) {
	...
	//conv1.parameter<Tensor<float>>("w").distribution<Gaussian>(0.5, 0.01);
	...
	pool1_out.add_postprocessing<process::SumPooling>(12, 12);
	...
	pool1_out2.add_postprocessing<process::SumPooling>(8, 8);
