...
{
	Benchmark<Handler, SparseIntermediateExecution> bench(argc, argv, "bench1", 3);
	/*
...
*/
	...
	bench.add_variable("t_obj", {0.25f, 0.5f, 0.75f, 0.95f});
	bench.add_variable("size", {64.0f});

	int mem = 128;
	int unit = 5;
	bench.run(1 /*mem/unit*/);
}
