...
int main(int argc, char **argv)
{
	...
	// scale the input values by deviding by the max value
	...
	experiment.add_train<dataset::Image>(input_path + "/train", _temporal_depth);
	experiment.add_test<dataset::Image>(input_path + "/test", _temporal_depth);
