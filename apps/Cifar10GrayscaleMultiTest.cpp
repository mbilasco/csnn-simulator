...
int main(int argc, char** argv) {
	...
	conv1.parameter<float>("annealing").set(0.95); //not specified in the paper Pattern Recognition
	...
	conv2.parameter<Tensor<float>>("th").distribution<distribution::Gaussian>(12.0, 0.1);
