...
# Folder path for input test images
...
output_files_directory = "/home/melassal/Workspace/Datasets/Original/KTH/Frames/5_frames/" + \
    datasetName + "_V_MN/"
...
train_images.append(
    (MAGIC_NUMBER_FOR_TRAINING_SET_IMAGE_FILE & 0xFF000000) >> 24)
train_images.append(
    (MAGIC_NUMBER_FOR_TRAINING_SET_IMAGE_FILE & 0xFF0000) >> 16)
...
train_labels.append(
    (MAGIC_NUMBER_FOR_TRAINING_SET_LABEL_FILE & 0xFF000000) >> 24)
train_labels.append(
    (MAGIC_NUMBER_FOR_TRAINING_SET_LABEL_FILE & 0xFF0000) >> 16)
...
for train_image_name in train_images_soret_list:
    ...
    # initialise, 0 is already used for boxing so 100 instead.
    classnumber = 100
    if datasetName == "KTH":
...
output_train_image_file = open(
    output_files_directory + "/" + "train-images.idx3-ubyte", "wb")
...
output_train_label_file = open(
    output_files_directory + "/" + "train-labels.idx1-ubyte", "wb")
...
####################
output_test_image_file = open(
    output_files_directory + "/" + "t10k-images.idx3-ubyte", "wb")
...
output_test_label_file = open(
    output_files_directory + "/" + "t10k-labels.idx1-ubyte", "wb")
