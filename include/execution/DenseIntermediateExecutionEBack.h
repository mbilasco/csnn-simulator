#ifndef _EXECUTION_DENSE_INTERMEDIATE_EXECUTION_EBACK_H
#define _EXECUTION_DENSE_INTERMEDIATE_EXECUTION_EBACK_H

#include "Experiment.h"
#include "SpikeConverter.h"

class DenseIntermediateExecutionEBack {

public:
	typedef Experiment<DenseIntermediateExecutionEBack> ExperimentType;

	DenseIntermediateExecutionEBack(ExperimentType& experiment);
