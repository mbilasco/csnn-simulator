...
class DenseIntermediateExecutionPar {

public:
	typedef Experiment<DenseIntermediateExecutionPar> ExperimentType;

	DenseIntermediateExecutionPar(ExperimentType& experiment);
