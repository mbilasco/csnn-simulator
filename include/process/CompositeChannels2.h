#ifndef _PROCESS_COMPOSITE_CHANNELS_2_H
#define _PROCESS_COMPOSITE_CHANNELS_2_H
...
namespace process
{
	...
	namespace _priv
	{
		class CompositeChannels2Helper
		{

		public:
			CompositeChannels2Helper() = delete;
		};
	}
	/**
	 * @brief CompositeChannels2 this pre-processing combines the two optical flow displacement channels (in the x and y directions) with the 
	 ...
	 */
	class CompositeChannels2 : public UniquePassProcess
	{

	public:
		CompositeChannels2();
		CompositeChannels2(std::string _expName, size_t _draw = 0, size_t _scalar = 1);
