#ifndef _PROCESS_GAUSSIAN_FILTER_H
#define _PROCESS_GAUSSIAN_FILTER_H
...
namespace process {
	...
	namespace _priv {
		class GaussianFilterHelper {

		public:
			GaussianFilterHelper() = delete;
	 ...
	 */
	class GaussianFilter : public UniquePassProcess {

	public:
		GaussianFilter();
		GaussianFilter(std::string _expName, size_t _draw = 0, size_t filter_size = 1, float center_dev = 1);
