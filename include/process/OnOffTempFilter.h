...
namespace process
{
	...
	public:
		...
		DefaultOnOffTempFilter(std::string expName, size_t filter_size, size_t tmp_filter_size = 1, float center_dev = 1, float surround_dev = 4, float center_tau = 1, float surround_tau = 4, size_t draw = 0);
