...
namespace process
{
	...
	/**
	 * @brief Extracts the optical flow information but as orientation and amplitude values. In drawing this data we use RGB, so make sure the grey-scale flag is not set to true.
	 * 
